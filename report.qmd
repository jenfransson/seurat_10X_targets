...
obj_orig_meta = tar_read(obj_orig_meta)
qc_groupby = tar_read(qc_groupby)
...
obj_filt2_meta = tar_read(obj_filt2_meta)
...
# 
# allfeatures = unlist(
#   lapply(names(alldata@assays),
#          function(x){
#            Features(alldata, assay = x)
#          }))
# 
# filt.features = allfeatures[! allfeatures %in% studyparams$qc_excludegenes]
# if(studyparams$qc_excludemito){
#   filt.features = filt.features[!grepl(studyparams$qc_mitopattern,
#                                        filt.features)]
# }
# if(studyparams$qc_excluderibo){
#   filt.features = filt.features[!grepl(studyparams$qc_ribopattern,
#                                        filt.features)]
# }
# 
